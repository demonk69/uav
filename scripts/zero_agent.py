#!/usr/bin/env python3
"""Run the M2 environment with zero actions for a finite number of steps."""
...
parser = argparse.ArgumentParser(description="Zero-action smoke agent for the UAV rendezvous M2 task.")
